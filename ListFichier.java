...
public void copyfile(File src, File dest,ArrayList<String>  list) throws IOException {
...
public void maj(File src, File dest,ArrayList<String>  list) throws IOException {
